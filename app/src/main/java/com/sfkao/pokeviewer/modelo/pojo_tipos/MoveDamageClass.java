...
public class MoveDamageClass {
    ...
    public String toString() {
        ...
        sb.append(MoveDamageClass.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MoveDamageClass) == false) {
            return false;
        }
        MoveDamageClass rhs = ((MoveDamageClass) other);
