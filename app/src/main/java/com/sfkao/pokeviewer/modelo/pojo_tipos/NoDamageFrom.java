...
public class NoDamageFrom {
    ...
    public String toString() {
        ...
        sb.append(NoDamageFrom.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NoDamageFrom) == false) {
            return false;
        }
        NoDamageFrom rhs = ((NoDamageFrom) other);
