...
public class HalfDamageFrom {
    ...
    public String toString() {
        ...
        sb.append(HalfDamageFrom.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HalfDamageFrom) == false) {
            return false;
        }
        HalfDamageFrom rhs = ((HalfDamageFrom) other);
