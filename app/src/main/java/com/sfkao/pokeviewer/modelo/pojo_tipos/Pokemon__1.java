...
public class Pokemon__1 {
    ...
    public String toString() {
        ...
        sb.append(Pokemon__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pokemon__1) == false) {
            return false;
        }
        Pokemon__1 rhs = ((Pokemon__1) other);
