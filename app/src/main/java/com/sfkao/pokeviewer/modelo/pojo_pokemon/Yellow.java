...
public class Yellow implements Serializable, Parcelable
{
    ...
    public final static Creator<Yellow> CREATOR = new Creator<Yellow>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Yellow createFromParcel(android.os.Parcel in) {
            return new Yellow(in);
        }

        public Yellow[] newArray(int size) {
            return (new Yellow[size]);
        }

    }
    ;
    private final static long serialVersionUID = 5259354633343990559L;

    protected Yellow(android.os.Parcel in) {
