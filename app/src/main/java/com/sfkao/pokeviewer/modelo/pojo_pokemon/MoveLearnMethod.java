...
public class MoveLearnMethod implements Serializable, Parcelable
{
    ...
    @Expose
    private String url;
    public final static Creator<MoveLearnMethod> CREATOR = new Creator<MoveLearnMethod>() {


        @SuppressWarnings({
            "unchecked"
        })
        public MoveLearnMethod createFromParcel(android.os.Parcel in) {
    ...
    ;
    private final static long serialVersionUID = 8712327610707782956L;

    protected MoveLearnMethod(android.os.Parcel in) {
