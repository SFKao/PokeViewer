...
public class DiamondPearl implements Serializable, Parcelable
{
    ...
    public final static Creator<DiamondPearl> CREATOR = new Creator<DiamondPearl>() {


        @SuppressWarnings({
            "unchecked"
        })
        public DiamondPearl createFromParcel(android.os.Parcel in) {
            return new DiamondPearl(in);
        }

        public DiamondPearl[] newArray(int size) {
            return (new DiamondPearl[size]);
        }

    }
    ;
    private final static long serialVersionUID = -7351284792469109888L;

    protected DiamondPearl(android.os.Parcel in) {
