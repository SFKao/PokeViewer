...
public class Silver implements Serializable, Parcelable
{
    ...
    public final static Creator<Silver> CREATOR = new Creator<Silver>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Silver createFromParcel(android.os.Parcel in) {
