...
public class DoubleDamageTo {
    ...
    public String toString() {
        ...
        sb.append(DoubleDamageTo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DoubleDamageTo) == false) {
            return false;
        }
        DoubleDamageTo rhs = ((DoubleDamageTo) other);
