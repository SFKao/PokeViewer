...
public class HalfDamageTo {
    ...
    public String toString() {
        ...
        sb.append(HalfDamageTo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HalfDamageTo) == false) {
            return false;
        }
        HalfDamageTo rhs = ((HalfDamageTo) other);
