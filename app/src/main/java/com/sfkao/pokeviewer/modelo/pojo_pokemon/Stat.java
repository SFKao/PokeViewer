...
public class Stat implements Serializable, Parcelable
{
    ...
    @Expose
    private String url;
    public final static Creator<Stat> CREATOR = new Creator<Stat>() {
    ...
    ;
    private final static long serialVersionUID = 7656569318563758822L;

    protected Stat(android.os.Parcel in) {
