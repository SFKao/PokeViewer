...
public class HeartgoldSoulsilver implements Serializable, Parcelable
{
    ...
    public final static Creator<HeartgoldSoulsilver> CREATOR = new Creator<HeartgoldSoulsilver>() {


        @SuppressWarnings({
            "unchecked"
        })
        public HeartgoldSoulsilver createFromParcel(android.os.Parcel in) {
            return new HeartgoldSoulsilver(in);
        }

        public HeartgoldSoulsilver[] newArray(int size) {
            return (new HeartgoldSoulsilver[size]);
        }

    }
    ;
    private final static long serialVersionUID = 4366150744020143691L;

    protected HeartgoldSoulsilver(android.os.Parcel in) {
