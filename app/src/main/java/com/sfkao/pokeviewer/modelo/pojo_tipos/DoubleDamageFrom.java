...
public class DoubleDamageFrom {
    ...
    public String toString() {
        ...
        sb.append(DoubleDamageFrom.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DoubleDamageFrom) == false) {
            return false;
        }
        DoubleDamageFrom rhs = ((DoubleDamageFrom) other);
