...
public class Platinum implements Serializable, Parcelable
{
    ...
    public final static Creator<Platinum> CREATOR = new Creator<Platinum>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Platinum createFromParcel(android.os.Parcel in) {
            return new Platinum(in);
        }

        public Platinum[] newArray(int size) {
            return (new Platinum[size]);
        }

    }
    ;
    private final static long serialVersionUID = -8599638507882087597L;

    protected Platinum(android.os.Parcel in) {
